...
LDFLAGS = -ldflags "-X=github.com/rickbassham/goad/version.version=$(VERSION) -X=github.com/rickbassham/goad/version.build=$(BUILD) -X=github.com/rickbassham/goad/version.travisTag=$(TRAVIS_TAG)"
